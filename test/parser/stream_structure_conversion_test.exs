defmodule Membrane.H265.StreamStructureConversionTest do
  ...
  @hvc1_au_fixtures "../fixtures/ms/*-hvc1-au.ms" |> Path.expand(__DIR__) |> Path.wildcard()
  @hvc1_nalu_fixtures "../fixtures/ms/*-hvc1-nalu.ms" |> Path.expand(__DIR__) |> Path.wildcard()
  @hev1_au_fixtures "../fixtures/ms/*-hev1-au.ms" |> Path.expand(__DIR__) |> Path.wildcard()
  @hev1_nalu_fixtures "../fixtures/ms/*-hev1-nalu.ms" |> Path.expand(__DIR__) |> Path.wildcard()
    ...
    case hvc do
      ...
      :hev1 ->
        ...
        %{nalu_length_size: converted_nalu_length_size} =
          H265.Parser.DecoderConfigurationRecord.parse(conversion_dcr)
        ...
        %{
          ...
          H265.Parser.DecoderConfigurationRecord.parse(fixture_dcr)
  ...
  defp split_aus_to_nalus(aus_binaries, stream_structure) do
    Enum.map(aus_binaries, fn au_binary ->
      {nalus, _splitter} =
        H265.Parser.NALuSplitter.split(
          au_binary,
          true,
          H265.Parser.NALuSplitter.new(stream_structure)
        )
